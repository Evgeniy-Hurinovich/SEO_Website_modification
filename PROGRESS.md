...
**Пауза / обновлено:** 11 августа 2026 — E5 + F1/F3 закрыты; F2 — еженедельный отчёт  
**Отчёт (main):** F1/F3 done; F2 шаблон готов
...
1. **F2** — первый еженедельный отчёт (понедельник): шаблон `snippets/f2-weekly-dashboard-template.md`.  
2. **C5** — после B3.  
