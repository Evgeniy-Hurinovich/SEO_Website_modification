...
**Пауза / обновлено:** 11 августа 2026 — B3 + C5 ✅; E5 + F1/F3 закрыты  
**Отчёт (main):** C5 custom.css verified live
...
1. Хостер: **B5.3–B5.5** (OPcache / MySQL / Redis).  
2. Разработчик: **B4.2–B4.3** (отложить Метрику и CRM).  
