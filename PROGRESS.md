...
| Пункт | Статус | Примечание |
|-------|--------|------------|
| **E1** DWH посадочная | ⏳ | Аудит + черновик текстовов 11.08: `snippets/e1-dwh-brief.md`, `snippets/e1-dwh-content.html` |
| **E2** BI | ⏳ | После E1 |
...
1. **E1** — согласовать/вставить тексты на `/services/dwh/` (после «можно»).  
2. **C5** — после B3.  
